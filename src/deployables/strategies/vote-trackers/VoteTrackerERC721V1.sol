    ...
    ERC165
{
     ...
     * @custom:storage-location erc7201:Decent.VoteTrackerERC721.main
     */
     ...
     * keccak256(abi.encode(uint256(keccak256("Decent.VoteTrackerERC721.main")) - 1)) & ~bytes32(uint256(0xff))
     */
